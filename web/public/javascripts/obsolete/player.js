...
class Player {
  ...
  constructor(game, x, y) {
    this.player = game.add.sprite(x, y, 'megaman');
    const player = this.player;
    player.sound = {};
    player.sound.blaster = game.add.audio('blaster');
    player.sound.hit = [game.add.audio('hit1'), game.add.audio('hit2'), game.add.audio('hit3')];
